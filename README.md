...
│   ├── coordinator.py           # Supervisor: decide next_step
...
│
├── mcp_servers/                 # Los 3 servidores MCP
│   ├── calculo_server.py
│   ├── graficado_server.py
│   └── retrieval_server.py
│
...
│   ├── rag_index.py             # Chunking/extracción de manuales + construcción de BM25 y ChromaDB
│   └── retriever.py             # BM25 + Chroma + Reciprocal Rank Fusion
│
